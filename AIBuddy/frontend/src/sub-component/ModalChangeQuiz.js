...
import { Box, Button, Typography, TextField, Modal, Divider, IconButton, List, ListItem, Icon} from '@mui/material';
    ...
    <Box component={"span"}>
      ...
      >
        ...
        sx={{
          ...
          <div>
            <Typography variant="h6" component="h2" >Quiz Questions</Typography>
