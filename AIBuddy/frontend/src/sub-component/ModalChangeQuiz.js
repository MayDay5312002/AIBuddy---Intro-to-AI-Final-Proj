...
export default function ModalChangeQuiz({oldTitle, oldContent, setFlashCards, flashCards, thread_title}) {
      ...
      >
        ...
        sx={{
          ...
          <div>
            ...
            <TextField id="Card Title" label="Card Title" value={title} onChange={(e) => setTitle(e.target.value)} variant="filled" required fullWidth/>
          </div>
